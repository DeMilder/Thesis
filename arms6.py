...
###########################################################
# Robot arm in n dimensions, with intermediate points. 
# The dimension below is equal to 3. To change the dimension,
# you can adjust the "n" variable and change the functions gamma and d_gamma
# so that they match the chosen dimension. Examples for n=2 are given in the
# gamma and d_gamma functions.
###########################################################
...
n=3 #dimension, please adjust the functions gamma and d_gamma accordingly
n_arms = 5
